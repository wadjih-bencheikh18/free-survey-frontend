      ...
      <div className="bg-gray-50 min-h-screen md:py-56 py-60 px-5">
        ...
        <div className="mt-10 flex justify-center ">
          <button
            ...
            className=" hover:bg-indigo-600 shadow text-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-500 "
          >
            Get started
          </button>
        </div>
